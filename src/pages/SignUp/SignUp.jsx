...
const SignUp = () => {
  ...
  return (
    <div className="main-container">
      <header className="signup-navbar">
        ...
        <div className="nav-items">
          <div className="language-tab">
            ...
            <div className="select-language-tab">
      ...
      <section id="plans">
        <div class="tile-cluster">
          <h4 class="section-heading">A plan to suit your needs</h4>
          <div class="tile-wrapper">
            <div class="card-tile">
              <div class="card-body">
                ...
                <p class="card-price">₹149/month</p>
              </div>
            </div>
            ...
            <div class="card-tile">
              <div class="card-body">
                ...
                <p class="card-price">₹649/month</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="reasons">
        <div class="tile-cluster2">
          <p class="section-heading">More reasons to join</p>
          <div class="tile-wrapper">
            <div class="card-tile">
              <div class="card-body">
                <div class="card-main-content">
                  <h4 class="card-title">Enjoy on your TV</h4>
                  <h6 class="card-para">
            ...
            <div class="card-tile">
              <div class="card-body">
                <div class="card-main-content">
                  <h4 class="card-title">Watch Everywhere</h4>
                  <h6 class="card-para">
            ...
            <div class="card-tile">
              <div class="card-body">
                <div class="card-main-content">
                  <h4 class="card-title">Create Profiles for Kids</h4>
                  <h6 class="card-para">
      ...
      <section className="after-faq-get-started">
        <form>
          <div className="email-input">
            <p className="label-description">
              Ready to watch? Enter your email to create or restart your
